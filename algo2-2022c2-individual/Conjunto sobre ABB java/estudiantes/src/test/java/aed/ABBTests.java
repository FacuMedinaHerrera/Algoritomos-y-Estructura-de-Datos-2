...
class ABBTests {
    ...
    void eliminar_elemento_con_sucesor_arriba() {
     ...
     void siguiente_inorder() {
        ...
        //  assertEquals(7, iterador.siguiente());
        //  assertEquals(10, iterador.siguiente());
        ...
        assertEquals(4, iterador.siguiente());
        assertEquals(5, iterador.siguiente());
        assertEquals(6, iterador.siguiente());
        assertEquals(7, iterador.siguiente());
        assertEquals(8, iterador.siguiente());
        Iterador<Integer> iterador2 = conjunto.iterador();
        conjunto.eliminar(5);
        conjunto.eliminar(7);
        assertEquals(4, iterador2.siguiente());
        assertEquals(6, iterador2.siguiente());
        assertEquals(8, iterador2.siguiente());
