...
class Conjunto
{
    ...
    private:
        ...
        void insertarAux(Nodo* posicion,const T& clave,Nodo*&actual);
        unsigned int cardinalAux(unsigned int &res, Nodo* actual) const;
        void destructorAux(Nodo* _raiz,Nodo* padre);
