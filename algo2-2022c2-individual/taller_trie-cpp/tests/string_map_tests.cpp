...
TEST(string_map_test, asignar) {
    ...
    pair<string,int> par = make_pair("hola",1);
    singleton.insert(par);
...
TEST(string_map_test, redefinir) {
    ...
    con_prefijos.insert(make_pair("casa",  2));
    con_prefijos.insert(make_pair("casona",  3));
    pair<string,int> par = make_pair("c", 2);
    con_prefijos.insert(par);
...
TEST(string_map_test, TrieDeTries) {
    ...
    con_prefijos.insert(make_pair("casa",  2));
    con_prefijos.insert(make_pair("casona",  3));
    pair<string,string_map<int>> vacioS = make_pair("vacio",vacio);
    dicc_dicc.insert(vacioS);
    pair<string,string_map<int>> SinGleton = make_pair("singleton",  singleton);
    dicc_dicc.insert(SinGleton);
    pair<string,string_map<int>> SinPrefijos = make_pair("sin_prefijos",  sin_prefijos);
    dicc_dicc.insert(SinPrefijos);
    pair<string,string_map<int>> ConPrefijos = make_pair("con_prefijos",  con_prefijos);
    dicc_dicc.insert(ConPrefijos);
